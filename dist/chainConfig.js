...
const formatSpend = (mul, value) => `${(0, util_1.formatBalance)(value.muln(mul), {
...
const UNITS = new util_1.BN(1000000000000);
const QUID = UNITS.divn(30);
const GRAND = QUID.muln(1000);
...
const SPEND_LIMITS = {
    BigSpender: formatSpend(1000, GRAND),
    ...
    Treasurer: formatSpend(10000, GRAND),
};
const endpoints = {
    relay: [
        {
...
exports.kusama = Object.assign({ name: types_1.SubstrateChain.Kusama, endpoints, selectedAssetHubEndpoint: 0, selectedEndpoint: 0, subscan: "https://kusama.subscan.io/", subscanAssetHub: "https://assethub-kusama.subscan.io", kodadot: "https://kodadot.xyz/ahk", tracks }, kusamaConfig);
