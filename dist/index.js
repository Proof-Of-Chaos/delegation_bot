                    ...
                    if (api.events.system.ExtrinsicSuccess.is(event)) {
                        if (isBatchCall(method)) {
                            ...
                            innerCalls.forEach((innerCall) => {
                                if (isDelegationExtrinsic(innerCall.section, innerCall.method) && innerCall.args[1].toString() == (0, keyring_1.encodeAddress)(account.address, chainConfig_1.kusama.ss58Format)) {
